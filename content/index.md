...
* **Fast** - Because its database free, rendering a page frequently takes less than a second. Try that with a WordPress page.
...
* **Developer Friendly** - Add functionality by creating your own plugin. [Create a Plugin in 5 Minutes](#)
